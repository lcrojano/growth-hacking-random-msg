    ...
    let growthHackingActions =[
      ...
      "Remember to Appear as a guest on tech-related podcasts to discuss your expertise and experiences",
      ...
      "Remember to Develop useful coding quizzes, tools, or resources that developers can use and share",
...
let messageId = Math.floor(Math.random()*growthHackingActions.length);

console.log(growthHackingActions[messageId]);